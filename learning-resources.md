Hello!  The Open Source software we will be working with involves a few core technologies - including using the command line, working with Git and Github, and with Exercism.io itself.  Here are some resources to get you started with these technologies :)
...
## Using Exercism.io
* [How it Works: For New Developers](http://exercism.io/how-it-works/newbie)
* [How it Works: For Experienced Developers](http://exercism.io/how-it-works)
* [The Command-Line Interface (CLI)](http://exercism.io/cli)

## Contributing to Exercism.io
* [Contribute to Exercism](http://exercism.io/contribute)
* [Contributing to Exercism.io](https://github.com/exercism/exercism.io/blob/master/CONTRIBUTING.md)
